...
public class Property {
	...
	public Property(String propertyId, @NotNull(message = "propertyType cannot be null") String propertyType,
			@NotNull(message = "numberOfAcres cannot be null") Long numberOfAcres,
			@NotNull(message = "Cost cannot be null") Long cost, Location location) {
		super();
